function  [opensimmodelpathscaled, IK_results_static_path, IK_res_ANGLES]=scaling_OLE(path_to_trc,  ID, pathtopfolder,  static_name, modelname, markersetname, scalesetupname, OPTIONS)
path_to_trc = replace(path_to_trc, '.c3d', '.trc');

static_name = [static_name, '.trc'];
